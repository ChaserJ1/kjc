...
//console.log(reWs_v_temp_B);
//console.log(ws_a_cugb_JJR_unit);
//console.log(ws_a_cugb_LWR_unit);
//console.log(ws_a_cugb_KYR_unit);
var len_data=0;
...
am4core.ready(function() {
    ...
    series_B1.columns.template.tooltipText = "{categoryX}: {valueY}";
