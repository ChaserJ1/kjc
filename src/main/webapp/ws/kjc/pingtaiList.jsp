    ...
    <script>
        layui.use('table', function () {
            ...
            table.render({
                ...
                , size: 'lg' //小尺寸的表格
                , cols: [[ //表头
                    { field: 'sort', title: '序号', width: 200, align: 'center', style: 'font-size:medium'}
                    , { field: 'name', title: '科技平台名称', width: 388, align: 'left', templet: addLink, style: 'font-size:medium'}
                    , { field: 'desc', title: '科技平台性质', width: 360, align: 'left', style: 'font-size:medium' }
                    , { field: 'addTime', title: '批准时间', width: 250, align: 'center', style: 'font-size:medium' }
                ]]
                , data:${pingtaiJson}
		...
		　　var addLink = d.name;
		   ...
		   if (addLink.length > 0) {                  
		        return '<a class="layui-table-link" href="' + d.path + '" lay-event="link">' + d.name + '</a>';                  
		   }
		}
    </script>
</body>
