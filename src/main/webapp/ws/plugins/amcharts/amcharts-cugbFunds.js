...
var reWs_vStr = $("#ws_a_cugb_NDZ_v").val();
reWs_vStr = reWs_vStr.replace("[","");
reWs_vStr = reWs_vStr.replace("]","");
var reWs_v_temp = reWs_vStr.split(",");
// 自然科学基金年资助项目数
var reWs_vStr_A = $("#ws_a_cugb_ZRK_v").val();
reWs_vStr_A = reWs_vStr_A.replace("[","");
reWs_vStr_A = reWs_vStr_A.replace("]","");
var reWs_v_temp_A = reWs_vStr_A.split(",");

var ws_a_cugb_NDZ_project = $("#ws_a_cugb_NDZ_project").val();
var ws_a_cugb_ZRK_project = $("#ws_a_cugb_ZRK_project").val();
var ws_a_cugb_NDZ_unit = $("#ws_a_cugb_NDZ_unit").val();
var ws_a_cugb_ZRK_unit = $("#ws_a_cugb_ZRK_unit").val();

//console.log(reWs_k_temp);
//console.log(reWs_v_temp);
//console.log(reWs_v_temp_A);
//console.log(ws_a_cugb_NDZ_unit);
//console.log(ws_a_cugb_ZRK_unit);
var len_data=0;
...
am4core.ready(function() {
    ...
    categoryAxis.title.text = ws_a_cugb_NDZ_project;
    categoryAxis.title.fontWeight = "bold";
    var valueAxis = chart.xAxes.push(new am4charts.ValueAxis());
    valueAxis.min = 0;
    valueAxis.title.text = ws_a_cugb_NDZ_unit;
