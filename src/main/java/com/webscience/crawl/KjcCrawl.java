...
import com.webscience.util.CrawlUtil;

public class KjcCrawl {
	public static final String webScienceUrl = "https://www1.cugb.edu.cn/research/";
	public static boolean getKjc(String curPage, String flagCode, String deptCode, String typeCode, String year) throws Exception {
		boolean res = false;
		String paperUrl  = webScienceUrl + "paperList.action?curPage="+curPage+"&year="+year+"&deptCode="+deptCode+"&paperTypeCode="+typeCode;
		String fundUrl  = webScienceUrl + "fundList.action?curPage="+curPage+"&year="+year+"&deptCode="+deptCode+"&fundTypeCode="+typeCode;
