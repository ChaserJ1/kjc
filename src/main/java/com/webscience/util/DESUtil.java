...
public class DESUtil {
	...
	public static void main(String[] args) throws Exception {
		// String url =
		// "jdbc:mysql://127.0.0.1:3306/webscience?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true";
		// String username = "webscience";
		// String password = "XXX";
		...
		// String url =
		// "jdbc:mysql://8.141.65.225:3306/webscience?useUnicode=true&characterEncoding=UTF-8&useSSL=false&autoReconnect=true";
