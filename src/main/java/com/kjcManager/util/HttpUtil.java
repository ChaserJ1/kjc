...
import com.kjcManager.json.ws_a_cugb_dept_detail;
...
//		 String url = "http://127.0.0.1:8080/kjcManager/kjcQuery.do";
//		 String url = "http://39.103.222.205:8080/kjcManager/kjcQuery.do";
...
//		 doPost(url, reObject.toString(), "UTF-8");
		 ...
		 String url = "http://127.0.0.1:8080/kjcManager/kjcQueryList.do";
		 dept.setFlagCode("paper");
		 dept.setTypeCode("null");
		 dept.setYear("2012~2017");
		 JSONObject reObject = JSONObject.fromObject(dept);
